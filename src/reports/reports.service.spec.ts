...
describe('ReportsService', () => {
  ...
  describe('createReport', () => {
    ...
    it('should create report with auto-generated flag', async () => {
      ...
      jest.spyOn(service as any, 'create').mockResolvedValue(autoGeneratedReport);
  ...
  describe('updateReport', () => {
    ...
    it('should handle service errors when updating report', async () => {
      ...
      await expect(service.updateReport(reportId, moderatorId, dto)).rejects.toThrow(error);
    });
  });
  ...
  describe('createReportAction', () => {
    ...
    it('should handle service errors when creating report action', async () => {
      ...
      await expect(service.createReportAction(moderatorId, dto)).rejects.toThrow(error);
    });
  });
  ...
  describe('assignReport', () => {
    ...
    it('should handle service errors when assigning report', async () => {
      ...
      await expect(service.assignReport(reportId, moderatorId)).rejects.toThrow(error);
    });
  });
  ...
  describe('resolveReport', () => {
    ...
    it('should resolve report with minimal data', async () => {
      ...
      jest.spyOn(service, 'updateReport').mockResolvedValue(resolvedReport);
    ...
    it('should handle service errors when resolving report', async () => {
      ...
      await expect(service.resolveReport(reportId, moderatorId, resolution)).rejects.toThrow(error);
    });
  });
  ...
  describe('dismissReport', () => {
    ...
    it('should dismiss report with detailed reason', async () => {
      const reportId = '1';
      const moderatorId = '2';
      const reason = 'Content does not violate community guidelines. User was expressing legitimate opinion.';

      const dismissedReport = { ...mockReport, status: 'dismissed' };
      jest.spyOn(service, 'updateReport').mockResolvedValue(dismissedReport);
    ...
    it('should handle service errors when dismissing report', async () => {
      ...
      await expect(service.dismissReport(reportId, moderatorId, reason)).rejects.toThrow(error);
    });
  });
  ...
  describe('escalateReport', () => {
    ...
    it('should escalate report with detailed reason', async () => {
      const reportId = '1';
      const moderatorId = '2';
      const reason = 'Complex case involving multiple violations. Requires senior moderator review and potential legal consultation.';

      const escalatedReport = { ...mockReport, status: 'escalated' };
      jest.spyOn(service, 'updateReport').mockResolvedValue(escalatedReport);
    ...
    it('should handle service errors when escalating report', async () => {
      ...
      await expect(service.escalateReport(reportId, moderatorId, reason)).rejects.toThrow(error);
    });
  });
  ...
  describe('getReportsForContent', () => {
    ...
    it('should handle service errors when getting reports for content', async () => {
      ...
      await expect(service.getReportsForContent(reportableType, reportableId)).rejects.toThrow(error);
    });
  });
