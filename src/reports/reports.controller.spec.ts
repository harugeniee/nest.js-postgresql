...
describe('ReportsController', () => {
  ...
  describe('createReport', () => {
    ...
    it('should create a report with auto-generated flag', async () => {
      ...
      jest.spyOn(service, 'createReport').mockResolvedValue(autoGeneratedReport as any);
  ...
  describe('getReport', () => {
    ...
    it('should handle invalid report ID format', async () => {
      ...
      const error = new HttpException('Invalid ID format', HttpStatus.BAD_REQUEST);
      jest.spyOn(service, 'getById').mockRejectedValue(error);
  ...
  describe('updateReport', () => {
    ...
    it('should update report with resolution details', async () => {
      ...
      const resolvedReport = { ...mockReport, status: 'resolved', action: 'content_removed' };
      jest.spyOn(service, 'updateReport').mockResolvedValue(resolvedReport as any);
    ...
    it('should handle service errors when updating report', async () => {
      ...
      await expect(controller.updateReport(reportId, req, dto)).rejects.toThrow(error);
    });
  });
  ...
  describe('assignReport', () => {
    ...
    it('should handle service errors when assigning report', async () => {
      ...
      await expect(controller.assignReport(reportId, req, body)).rejects.toThrow(error);
    });
    ...
    it('should handle invalid moderator ID', async () => {
      ...
      const error = new HttpException('Invalid moderator ID', HttpStatus.BAD_REQUEST);
      jest.spyOn(service, 'assignReport').mockRejectedValue(error);
  ...
  describe('resolveReport', () => {
    ...
    it('should resolve report with minimal data', async () => {
      ...
      const resolvedReport = { ...mockReport, status: 'resolved', action: 'no_action' };
      jest.spyOn(service, 'resolveReport').mockResolvedValue(resolvedReport as any);
    ...
    it('should handle service errors when resolving report', async () => {
      ...
      await expect(controller.resolveReport(reportId, req, body)).rejects.toThrow(error);
    });
  });
  ...
  describe('dismissReport', () => {
    ...
    it('should handle service errors when dismissing report', async () => {
      ...
      await expect(controller.dismissReport(reportId, req, body)).rejects.toThrow(error);
    });
    ...
    it('should dismiss report with detailed reason', async () => {
      ...
      const body: DismissReportDto = { 
        reason: 'Content does not violate community guidelines. User was expressing legitimate opinion.' 
      };

      const dismissedReport = { ...mockReport, status: 'dismissed' };
      jest.spyOn(service, 'dismissReport').mockResolvedValue(dismissedReport as any);
  ...
  describe('escalateReport', () => {
    ...
    it('should handle service errors when escalating report', async () => {
      ...
      await expect(controller.escalateReport(reportId, req, body)).rejects.toThrow(error);
    });
    ...
    it('should escalate report with detailed reason', async () => {
      ...
      const body: EscalateReportDto = { 
        reason: 'Complex case involving multiple violations. Requires senior moderator review and potential legal consultation.' 
      };

      const escalatedReport = { ...mockReport, status: 'escalated' };
      jest.spyOn(service, 'escalateReport').mockResolvedValue(escalatedReport as any);
  ...
  describe('createReportAction', () => {
    ...
    it('should create report action with metadata', async () => {
      ...
      const actionWithMetadata = { ...mockReportAction, metadata: dto.metadata };
      jest
        .spyOn(service, 'createReportAction')
    ...
    it('should handle service errors when creating report action', async () => {
      ...
      await expect(controller.createReportAction(reportId, req, dto)).rejects.toThrow(error);
    });
  });
  ...
  describe('getReportsForContent', () => {
    ...
    it('should handle service errors when getting reports for content', async () => {
      ...
      await expect(controller.getReportsForContent(reportableType, reportableId)).rejects.toThrow(error);
    });
  });
  ...
  describe('getDuplicateReports', () => {
    ...
    it('should handle service errors when getting duplicate reports', async () => {
      ...
      await expect(controller.getDuplicateReports(reportableType, reportableId)).rejects.toThrow(error);
    });
  });
  ...
  describe('mergeDuplicateReports', () => {
    ...
    it('should handle service errors when merging reports', async () => {
      ...
      const error = new HttpException('Insufficient reports to merge', HttpStatus.BAD_REQUEST);
      jest.spyOn(service, 'mergeDuplicateReports').mockRejectedValue(error);

      await expect(controller.mergeDuplicateReports(req, body)).rejects.toThrow(error);
    });
    ...
    it('should handle invalid report IDs when merging', async () => {
      ...
      const error = new HttpException('Invalid report IDs', HttpStatus.BAD_REQUEST);
      jest.spyOn(service, 'mergeDuplicateReports').mockRejectedValue(error);
    ...
    it('should handle insufficient reports for merging', async () => {
      ...
      const error = new HttpException('At least 2 reports required for merging', HttpStatus.BAD_REQUEST);
      jest.spyOn(service, 'mergeDuplicateReports').mockRejectedValue(error);
  ...
  describe('getReportStats', () => {
    ...
    it('should return statistics without filters', async () => {
      ...
      const mockStats = {
        ...
        dismissedReports: 10,
        escalatedReports: 5,
        reportsByStatus: { pending: 20, under_review: 15, resolved: 50, dismissed: 10, escalated: 5 },
        reportsByPriority: { low: 30, medium: 40, high: 25, urgent: 5 },
        reportsByType: { article: 60, comment: 30, user: 10 },
        reportsByReason: { spam: 40, harassment: 25, hate_speech: 20, other: 15 },
  ...
  describe('getAssignedReports', () => {
    ...
    it('should handle service errors when getting assigned reports', async () => {
      ...
      await expect(controller.getAssignedReports(req, dto)).rejects.toThrow(error);
    });
  });
